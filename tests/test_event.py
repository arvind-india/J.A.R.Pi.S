...
class EventTest(unittest.TestCase):
    ...
    def test_event_find_by_id(self):
        event = Event(-1000, "Party", datetime.datetime.now(), datetime.datetime.now(), 1, 1, 1, None)
        event.create()
        result_event = EventManager.findById(-1000)
    ...
    def test_convert_from_create_default_and_birthday_event(self):
        ...
        birthday_event.create()
        birthday = EventManager.findById(-1000)
        event = EventManager.findById(-1001)
    ...
    def test_delete_birthday_event(self):
        ...
        birthday_event.create()
        self.assertIsNotNone(EventManager.findById(-1001))
        birthday_event.delete()
        with self.assertRaises(EventNotFoundException):
            EventManager.findById(-1001)
    ...
    def test_create_scheduled_event(self):
        ...
        birthday.create()
        birthdayResult = EventManager.findById(-1000)
    ...
    def test_find_upcoming_events_by_user(self):
        ...
        eventList1User1 = EventManager.findByUser(user, datetime.datetime(2017, 3, 19))
        eventList2User1 = EventManager.findByUser(user)
        eventList1User2 = EventManager.findByUser(user2, datetime.datetime(2017, 3, 19))
        eventList2User2 = EventManager.findByUser(user2)
